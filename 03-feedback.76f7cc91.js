...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("form");r.addEventListener("submit",u),r.addEventListener("input",(0,e.default)(a,500));const o="feedback-form-state",n={};function a(e){n[e.target.name]=e.target.value,localStorage.setItem(o,JSON.stringify(n))}function u(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(o),console.log(n)}function l(e){const t=localStorage.getItem(o);t&&(r.value=JSON.parse(t))}
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.76f7cc91.js.map